<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <form action="<?php echo e(route('orders.checkout')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row g-5">
                    <div class="col-md-12 col-lg-6 col-xl-7">
                        ...
                        <div class="form-item">
							...
							<input type="text" class="form-control" name="address1" value="<?php echo e(old('address1', auth()->user()->address1)); ?>">
                            <br>
							<input type="text" class="form-control" name="address2" value="<?php echo e(old('address2', auth()->user()->address2)); ?>">
                        </div>
                        <div class="form-item">
                            ...
                            <select name="province_id" class="form-control" id="shipping-province">
                                ...
                                <?php $__currentLoopData = $provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $province): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php echo e(auth()->user()->province_id == $id ? 'selected' : null); ?> value="<?php echo e($id); ?>"><?php echo e($province); ?></option>
                            ...
                            <select name="shipping_city_id" class="form-control" id="shipping-city">
                                ...
                                <?php if($cities): ?>
                                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo e(auth()->user()->city_id == $id ? 'selected' : null); ?> value="<?php echo e($id); ?>"><?php echo e($city); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </select>
                        </div>
                        <div class="form-item">
							...
							<input type="text" class="form-control" name="postcode" value="<?php echo e(old('postcode', auth()->user()->postcode)); ?>">
                        </div>
                        <div class="form-item">
                            <label>Phone  <span class="required">*</span></label>
							<input type="text" class="form-control" name="phone" value="<?php echo e(old('phone', auth()->user()->phone)); ?>">
                        </div>
                        <div class="form-item">
                            <label>Email Address </label>
                            <input type="text" class="form-control" name="email" value="<?php echo e(old('email', auth()->user()->email)); ?>">
                        </div>
                        <div class="form-item">
                            <label>Order Notes </label>
                            <input type="textarea" class="form-control" name="note" value="<?php echo e(old('note')); ?>">
                        </div>
                        <div class="form-item">
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-5">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center mt-2">
                                                    <img src="<?php echo e($image); ?>" class="img-fluid rounded" style="width: 90px; height: 90px;" alt="">
                                                </div>
                                            </th>
                                            <td class="py-5"><?php echo e($product->name); ?></td>
                                            <td class="py-5">Rp. <?php echo e(number_format($product->price)); ?></td>
                                            <td class="py-5"><?php echo e($item->qty); ?></td>
                                            <td class="py-5">Rp. <?php echo e(number_format($item->price * $item->qty)); ?></td>
                                        </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-5">
                                            <div class="py-3 border-bottom border-top">
                                                <p class="mb-0 text-dark">Rp. <?php echo e(Cart::subtotal(0, ",", ".")); ?></p>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="unique_code" value="<?php echo e($unique_code); ?>" class="form-control unique_code" readonly></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                        </th>
                                        ...
                                        <td class="py-5">
                                            <div class="py-3 border-bottom border-top">
                                                <p class="mb-0 text-dark total-amount"><?php echo e(number_format((int)Cart::subtotal(0,'','') + (int)$unique_code)); ?></p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="row g-4 text-center align-items-center justify-content-center border-bottom py-3">
                            <div class="col-12">
                                ...
                                <div class="col-12">
                                    <img id="images" src="<?php echo e(asset('images/qr.jpg')); ?>" alt="">
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('frontend.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/iqbalrizqi/Desktop/app/laravel/vivia-app/resources/views/frontend/orders/checkout.blade.php ENDPATH**/ ?>