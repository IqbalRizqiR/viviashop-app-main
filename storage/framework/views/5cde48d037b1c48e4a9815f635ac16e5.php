            ...
            <div class="col-md-12 col-lg-5">
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-indicators">
                        <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="carousel-inner">
                        <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $images): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-lg-8 text-end">
                    <ul class="nav nav-pills d-inline-flex text-center mb-5">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="nav-item">
                                <a class="d-flex change-the-class py-2 m-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-<?php echo e($row->iteration+2); ?>">
                                    <span class="text-dark" style="width: 130px;"><?php echo e($row->categories->name); ?></span>
                                </a>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-3 border border-secondary border-top-0 rounded-bottom">
                                                <a href="<?php echo e(route('shop-detail', $row->id)); ?>"><h4><?php echo e($row->products->name); ?></h4></a>
                                                ...
                                                <div class="d-flex justify-content-center flex-lg-wrap">
                                                    ...
                                                    <a class="btn border add-to-card border-secondary rounded-pill px-3 text-primary" href="" product-id="<?php echo e($row->products->id); ?>" product-type="<?php echo e($row->products->type); ?>" product-slug="<?php echo e($row->products->slug); ?>">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-xl-3">
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-3 border border-secondary border-top-0 rounded-bottom">
                                                ...
                                                <div class="d-flex justify-content-center flex-lg-wrap">
                                                    <p class="text-dark fs-5 fw-bold mb-2">Rp. <?php echo e(number_format($row->products->price)); ?></p>
                                                    <a class="btn border add-to-card border-secondary rounded-pill px-3 text-primary" href="" product-id="<?php echo e($row->products->id); ?>" product-type="<?php echo e($row->products->type); ?>" product-slug="<?php echo e($row->products->slug); ?>"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    <div class="p-4 rounded-bottom">
                        ...
                        <div class="d-flex justify-content-between flex-lg-wrap">
                            <p class="text-dark fs-5 fw-bold mb-0">Rp. <?php echo e(number_format($row->price)); ?></p>
                            <a class="btn border border-secondary rounded-pill px-3 text-primary add-to-card" href="" product-id="<?php echo e($row->id); ?>" product-type="<?php echo e($row->type); ?>" product-slug="<?php echo e($row->slug); ?>">
                                <i class="fa fa-shopping-bag me-2 text-primary"></i>
                                Add to cart
                            </a>
                        </div>
...
<?php echo $__env->make('frontend.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/iqbalrizqi/Desktop/app/laravel/vivia-app/resources/views/frontend/homepage.blade.php ENDPATH**/ ?>