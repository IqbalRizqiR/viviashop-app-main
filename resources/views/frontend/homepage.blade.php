            ...
            <div class="tab-content">
                ...
                @foreach($categoriesName as $category)
                    <div
                        ...
                        <div class="row g-4">
                            @foreach($category->where('slug', $category->slug)->products as $row)
                                <div class="col-md-6 col-lg-4 col-xl-3">
                                    <div class="rounded position-relative fruite-item">
                                        <div class="fruite-img">
                                            @php
        ...
        <div class="owl-carousel vegetable-carousel justify-content-center">
            @foreach ($popular as $row)
                <div class="border border-primary rounded position-relative vesitable-item">
                    ...
                    {{--  <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;">{{ $row->categories->name }}</div>  --}}
                    <div class="p-4 rounded-bottom">
                        ...
                        <div class="d-flex justify-content-between flex-lg-wrap">
                            <p class="text-dark fs-5 fw-bold mb-0">Rp. {{ number_format($row->price) }}</p>
                            <a class="btn border border-secondary rounded-pill px-3 text-primary add-to-card" href="" product-id="{{ $row->id }}" product-type="{{ $row->type }}" product-slug="{{ $row->slug }}">
                                <i class="fa fa-shopping-bag me-2 text-primary"></i>
                                Add to cart
                            </a>
                        </div>
