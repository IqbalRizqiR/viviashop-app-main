        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('admin.orders.storeAdmin') }}"method="POST" enctype="multipart/form-data"
                    id="order-form" onsubmit="return handleFormSubmit(event)">
                    @csrf
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly name="first_name" value="Admin" class="form-control"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="last_name">Last Name</label>
                                    <input type="text" readonly name="last_name" value="Toko" class="form-control"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="address1">Address Line 1</label>
                                    <input type="text" readonly name="address1" value="Cukir, Jombang"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly name="postcode" value="102112" class="form-control"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="phone">Phone</label>
                                    <input type="text" readonly name="phone" value="9121240210" class="form-control"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="email" readonly name="email" value="admin@gmail.com"
                                        class="form-control" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tr class="bg-success">
                                                            ...
                                                            <td class="text-right"><strong id="grand-total">Rp 0</strong>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                ...
                                <div id="payment-gateway-section" style="display: none;">
                                    <button type="button" id="pay-button" class="btn btn-success btn-lg">Process
                                        Payment</button>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <button type="button" class="close" data-dismiss="modal"
                                            onclick="closeBarcodeModal()" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body text-center">
                                        <div id="scanner"
                                            style="width: 100%; height: 300px; border: 1px solid #ccc; position: relative;">
                                        </div>
                                        <div id="result" class="mt-3"></div>
                                        <div class="mt-3">
                                            <button id="start-scan" class="btn btn-success" type="button">Start
                                                Scanner</button>
                                            <button id="stop-scan" class="btn btn-danger" type="button">Stop
                                                Scanner</button>
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script type="text/javascript"
        @if (config('midtrans.isProduction')) src="https://app.midtrans.com/snap/snap.js"
    @else
        src="https://app.sandbox.midtrans.com/snap/snap.js" @endif
    ...
    <script>
        ...
        function initializeScanner() {
            ...
            Quagga.init({
                ...
                if (err) {
                    ...
                    document.getElementById('result').innerHTML = '<div class="alert alert-danger">Camera error: ' +
                        err.message + '</div>';
                    return;
                }
                ...
                document.getElementById('result').innerHTML =
                    '<div class="alert alert-success">Camera ready! Point at barcode</div>';
        ...
        Quagga.onDetected(function(result) {
            ...
            // Show detected code
            document.getElementById('result').innerHTML = '<div class="alert alert-info">Found: <strong>' + code +
                '</strong><br>Looking up product...</div>';
        ...
        function searchBarcodeId() {
            ...
            if (barcode) {
                ...
                document.getElementById('result').innerHTML =
                    '<div class="alert alert-warning">Please enter a barcode</div>';
            }
        }
            ...
            fetch('/admin/products/find-barcode', {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        document.getElementById('result').innerHTML =
                            '<div class="alert alert-success">✓ Product added: <strong>' + product.name +
                            '</strong></div>';
                        ...
                        document.getElementById('result').innerHTML =
                            '<div class="alert alert-warning">✗ Product not found: <strong>' + barcode +
                            '</strong><br><button onclick="initializeScanner()" class="btn btn-primary btn-sm mt-2">Scan Again</button></div>';
                    }
                })
                .catch(error => {
                    console.error('Error:', error);
                    document.getElementById('result').innerHTML =
                        '<div class="alert alert-danger">Error occurred<br><button onclick="initializeScanner()" class="btn btn-primary btn-sm mt-2">Try Again</button></div>';
                });
        }
    </script>
    <script>
            ...
            fetch(`/admin/products/${productId}/all-variants`, {
                ...
                .then(data => {
                    ...
                    if (data.success && data.data.length > 0) {
                        ...
                        $(`#attribute-section-${itemIndex}`).html(
                            '<p class="text-muted"><small>No variants available for this product</small></p>');
                    }
                })
                .catch(error => {
                    console.error('Error loading variants:', error);
                    $(`#attribute-section-${itemIndex}`).html(
                        '<p class="text-danger"><small>Error loading variants</small></p>');
                });
        }
                ...
                fetch(`/admin/products/${productId}`, {
                    ...
                    .then(data => {
                        if (data.success && data.product) {
                            ...
                            $(`#price-display-${itemIndex}`).html(
                                `<span class="text-warning">Price not available</span>`);
                        }
                    })
                    .catch(error => {
    ...
    `;
            ...
            variants.forEach(variant => {
                ...
                if (variant.variant_attributes && variant.variant_attributes.length > 0) {
                    const attrs = variant.variant_attributes.map(attr =>
                        `${attr.attribute_name}: ${attr.attribute_value}`).join(', ');
                    variantLabel += ` (${attrs})`;
                }
                ...
                html +=
                    `<option value="${variant.id}" data-price="${variant.price}" data-sku="${variant.sku}" data-stock="${variant.stock || 0}">${variantLabel}</option>`;
            });
    ...
    `;
        ...
        function updateAvailableOptions(itemIndex, selectedAttributes, allVariants, variantOptions) {
            ...
            Object.keys(variantOptions).forEach(attributeName => {
                const buttons = $(
                    `.variant-option[data-attribute="${attributeName}"][data-item-index="${itemIndex}"]`);
                buttons.each(function() {
                    ...
                    if (!isAvailable && !isSelected) {
                        $(this).removeClass('btn-outline-secondary btn-primary').addClass(
                            'btn-outline-danger');
                        $(this).attr('title', 'Tidak tersedia untuk kombinasi yang dipilih');
                    } else if (!isSelected) {
                        $(this).removeClass('btn-primary btn-outline-danger').addClass(
    ...
    `;
            ...
            variants.forEach(variant => {
                ...
                variantHtml +=
                    `<option value="${variant.id}" data-price="${variant.price}" data-sku="${variant.sku}" data-stock="${variant.stock || 0}" ${isDisabled}>${variantLabel}${disabledText}</option>`;
            });
        ...
        function updatePricingSummary() {
            ...
            orderItems.each(function(index) {
                ...
                const productName = item.find('input[name="product_id[]"]').siblings('input[type="text"]').val() ||
                    'Unknown Product';
            ...
            for (let select of variantSelects) {
                ...
                if (variantId) {
                    if (selectedVariantIds.includes(variantId)) {
                        alert(
                            'You cannot select the same product variant multiple times. Please choose different variants.');
                        return false;
                    }
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        if (response.payment_token) {
                                ...
                                snap.pay(response.payment_token, {
                                    onSuccess: function(result) {
                                        ...
                                        window.location.href =
                                            '{{ route('admin.payment.finish') }}?order_id=' +
                                            orderCode;
                                    },
                                    onPending: function(result) {
                                        ...
                                        window.location.href =
                                            '{{ route('admin.payment.unfinish') }}?order_id=' +
                                            orderCode;
                                    },
                                    onError: function(result) {
                                        alert('Payment failed. Please try again.');
                                        window.location.href =
                                            '{{ route('admin.payment.error') }}?order_id=' +
                                            orderCode;
                                    },
                                    onClose: function() {
                            ...
                            window.location.href = '{{ route('admin.orders.show', ':id') }}'.replace(':id',
                                response.order_id);
                        }
                    } else {
